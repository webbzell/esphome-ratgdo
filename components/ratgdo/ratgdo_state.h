...
// True when TTC has been disabled entirely (via the wall control's menu).
inline constexpr bool ttc_is_disabled(TtcState state)
{
    return state == TtcState::DISABLED;
}
